...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-29 14:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d6cff200-ced9-4346-b7c0-e741cad5969e.git
$ cd d6cff200-ced9-4346-b7c0-e741cad5969e
```
